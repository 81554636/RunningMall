...
insert into rmall_product(id,displayName,price,createDate,lastUpdate) 
	values(1,'wine红酒',230.00,current_timestamp,current_timestamp),(2,'kiwi奇异果',120.00,current_timestamp,current_timestamp);