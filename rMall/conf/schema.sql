...
insert into rmall_product(id,displayName,createDate,lastUpdate,url,isValid) values(1,'wine红酒-注册送好礼',current_timestamp,current_timestamp,'http://www.metro.com.cn/~/media/CN-Metro/image/campaign-image/others/woty-2014-iv-940x200.jpg',false);
insert into rmall_product(id,displayName,createDate,lastUpdate,url,isValid) values(2,'kiwi奇异果-注册送好礼',current_timestamp,current_timestamp,'http://cdn.fruitday.com/up_images/1430200859.jpg',false);

insert into rmall_product(id,displayName,createDate,lastUpdate,url,isValid) values(1001,'wine红酒',current_timestamp,current_timestamp,'http://www.metro.com.cn/~/media/CN-Metro/image/campaign-image/others/woty-2014-iv-940x200.jpg',true);
insert into rmall_product(id,displayName,createDate,lastUpdate,url,isValid) values(1002,'kiwi奇异果',current_timestamp,current_timestamp,'http://cdn.fruitday.com/up_images/1430200859.jpg',true);
